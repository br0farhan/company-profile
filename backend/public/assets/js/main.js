...
function updateProfileContent(data) {
    ...
    if (experienceYears) experienceYears.textContent = data.experience_years;
    if (projectsCompleted) projectsCompleted.textContent = data.projects_completed;
    if (technologiesUsed) technologiesUsed.textContent = data.technologies_used;
